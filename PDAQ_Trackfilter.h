...
struct histograms{
    ...
    TH1F* h_scint_timediffa = new TH1F("h_scint_timediffa", "h_scint_timediffa;Time Difference [ns]", 5000, 0, 50000);
    TH1F* h_scint_timediffb = new TH1F("h_scint_timediffb", "h_scint_timediffb;Time Difference [ns]", 5000, 0, 50000);
